      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 text-center sm:text-right">
        <div className="space-y-4">
          <div className="flex items-center gap-2 justify-center sm:justify-end">
            <span className="text-2xl font-extrabold text-amber-400">الأستاذ</span>
            <span className="w-9 h-9 rounded-xl bg-amber-400/10 text-amber-400 flex items-center justify-center">
              <Languages size={20} />
            </span>
          </div>
          <p className="text-sm text-slate-400 leading-relaxed">
            منصة تعليمية متخصصة في اللغة العربية، بتقدّم شرح مبسط ومتابعة مستمرة عشان توصل لأعلى الدرجات في الثانوية العامة.
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex items-center gap-2 justify-center sm:justify-end">
              <span>info@alostaz-platform.com</span>
              <Mail size={16} />
            </li>
            <li className="flex items-center gap-2 justify-center sm:justify-end">
